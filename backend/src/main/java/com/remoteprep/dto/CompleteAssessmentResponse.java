...
/**
 * Client-safe response DTO for completed assessment final results.
 * Excludes internal JPA entity graphs, hidden test cases, source code, and compiler internals.
 */
public class CompleteAssessmentResponse {
    ...
    public CompleteAssessmentResponse() {
    }

    public CompleteAssessmentResponse(Long assessmentId,
                                      Long studentId,
                                      String studentName,
                                      String rollNumber,
