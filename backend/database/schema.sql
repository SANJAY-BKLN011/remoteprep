...
CREATE TABLE dsa_submissions (
    ...
    result_status ENUM('ACCEPTED', 'WRONG_ANSWER', 'COMPILATION_ERROR', 'RUNTIME_ERROR', 'TIME_LIMIT_EXCEEDED', 'UNATTEMPTED', 'PENDING', 'OUTPUT_LIMIT_EXCEEDED', 'EXECUTION_ERROR') NOT NULL,
